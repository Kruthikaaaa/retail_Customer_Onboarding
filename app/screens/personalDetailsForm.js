...
import { View, Text, Image, ScrollView, StyleSheet, TouchableOpacity, Button, Pressable } from 'react-native';
  ...
  const onSubmit = async () => {
    ...
    if (Object.keys(errors).length > 0) {
      ...
      try {
        ...
        router.navigate('screens/panVerificationScreen'); // Navigation to panVerificationScreen
      } catch (err) {
